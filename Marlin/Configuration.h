...
#define CUSTOM_MACHINE_NAME "Heater 1"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, 1024, 75} //XYZ_STEPS, E}
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 503
#define Y_MAX_POS 477
